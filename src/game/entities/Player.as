package game.entities 
{
	...
	/**
	 * PURPOSE: REPRESENTS THE LOCAL PLAYER. THE LOCAL PLAYER WILL NOT HAVE A MESH.
	 * 
	 * TO DO:
	 * FINISH BASESPACIALENTITY AND CHANGE INHERITANCE TO IT.
	 * MOVE STANDARDISED MOVEMENT CODE TO BASESPACIALENTITY OR A SUBOBJECT OF IT. (WILL HANDLE ACCELERATION, FRICTION, GRAVITY, HITDETECTION ETC. PLAYER WILL KEEP A MOVE FUNCTION BUT INSTEAD OF DIRECTLY MANIPULATING THE POSITION IT WILL USE SOMETHING LIKE MOVEMENT.PUSH(vector))
	 */
